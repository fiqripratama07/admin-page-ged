                ...
                <div className="site-wrap" id="home-section">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-12">
                                    <a href="#" className=""><span className="mr-2  icon-envelope-open-o"></span> <span
                                        className="d-none d-md-inline-block">info@ged.com</span></a>
                                    <span className="mx-md-2 d-inline-block"></span>
                                    <a href="#" className=""><span className="mr-2  icon-phone"></span> <span
                                        className="d-none d-md-inline-block">(021) 913745</span></a>


                                    <div className="float-right">

                                        <a href="#" className=""><span className="mr-2  icon-twitter"></span> <span
                                            className="d-none d-md-inline-block">Twitter</span></a>
                                        <span className="mx-md-2 d-inline-block"></span>
                                        <a href="#" className=""><span className="mr-2  icon-facebook"></span> <span
                                            className="d-none d-md-inline-block">Facebook</span></a>
                        ...
                        <div className="container">
                            <div className="row align-items-center position-relative">
                                ...
                                <div className="site-logo">
                                    <a href="index.html" className="text-black"><span className="text-primary">GED</span></a>
                                </div>
                            ...
                            <div className="container">
                                <div className="row align-items-center">
                                    <div className="col-lg-6">
                                        ...
                                        <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est
                            ...
                            <div className="container">
                                <div className="owl-carousel owl-all">
                                    <div className="service text-center">
                                        <a href="#"><img src="images/cargo_sea_small.jpg" alt="Image" className="img-fluid"/></a>
                                    ...
                                    <div className="service text-center">
                                        <a href="#"><img src="images/cargo_air_small.jpg" alt="Image" className="img-fluid"/></a>
                                        <div className="px-md-3">
                        ...
                        <div className="container">
                            ...
                            <div className="owl-carousel owl-all">
                                ...
                                <div className="block-team-member-1 text-center rounded h-100">
                                    ...
                                    <span className="d-block font-gray-5 letter-spacing-1 text-uppercase font-size-12 mb-3">Frontend Dev</span>
                                    <p className="mb-4">Far far away, behind the word mountains, far from the countries
                                        Vokalia and Consonantia, there live the blind texts.</p>
                                    <div className="block-social-1">
                                        <a href="#" className="btn border-w-2 rounded primary-primary-outline--hover"><span
                    ...
                    <div className="site-section py-5" id="blog-section">
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="mb-5 d-flex blog-entry" data-aos="fade-right" data-aos-delay="">
                                        <a href="#" className="blog-thumbnail"><img src="images/cargo_sea_small.jpg"
                                                                                    alt="Image" className="img-fluid"/></a>
                                        <div className="blog-excerpt">
                                            <span className="d-block text-muted">Apr 19, 2019</span>
                                            <h2 className="h4  mb-3"><a href="single.html">Knowing the Difference Is Key to
                                                Effective Logistics</a></h2>

                                            <p>Far far away, behind the word mountains, far from the countries Vokalia and
                                                Consonantia, there live the blind texts</p>
                                            <p><a href="single.html" className="text-primary">Read More</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="mb-5 d-flex blog-entry" data-aos="fade-right" data-aos-delay="">
                                        <a href="#" className="blog-thumbnail"><img src="images/cargo_air_small.jpg"
                                                                                    alt="Image" className="img-fluid"/></a>
                                        <div className="blog-excerpt">
                                            <span className="d-block text-muted">Apr 19, 2019</span>
                                            <h2 className="h4  mb-3"><a href="single.html">Knowing the Difference Is Key to
